...
describe Happening::DecayFactory do
  ...
  describe '#call' do
    ...
    it 're-writes decay events' do
      ...
      Happening.create!(user: user, event_kind: :habit_success_decay, reported_at: 7.days.ago.beginning_of_day, point_value: -1)
      Happening.create!(user: user, event_kind: :habit_success_decay, reported_at: 6.days.ago.beginning_of_day, point_value: -1)
      Happening.create!(user: user, event_kind: :habit_success_decay, reported_at: 5.days.ago.beginning_of_day, point_value: -1)

      Happening.create!(user: user, event_kind: :habit_success_decay, reported_at: 3.days.ago.beginning_of_day, point_value: -1)
